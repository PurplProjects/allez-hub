// ── ALLEZ FENCING THEME ───────────────────────────────────────
// Light and dark palettes. Consumed via useTheme() hook.

export const clubInfo = {
  clubName:  'Allez Fencing',
  clubShort: 'AF',
  coachName:  'Christian Galesloot',
  coachEmail: 'chris@allezfencing.com',
};
...
// Legacy default export so existing components still work
// before they are migrated to useTheme()
